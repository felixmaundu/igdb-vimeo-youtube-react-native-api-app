...
const TopRatedMore = (props) => {
    ...
    const getMovies = () => {
        const apiURL = `https://api.themoviedb.org/3/tv/top_rated?api_key=53939b3da3d575c42c212fb77c52c5a5&page=${currentPage}`;
        fetch(apiURL)
